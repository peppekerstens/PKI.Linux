function Get-Certificate {
    ...
    .Description
        Submits a certificate request to an enrollment server. This cmdlet requires Windows infrastructure
    ...
    Write-Warning "Get-Certificate is not implemented in PKI.Linux. This cmdlet requires Windows infrastructure (Active Directory, Certificate Services, or Task Scheduler). Contributions welcome: https://github.com/peppekerstens/PKI.Linux"
}
